  ...
  return (
    <SkyBackground>
      <div className="flex flex-col h-screen overflow-hidden w-full">
        <header className="flex items-center px-4 md:px-8 py-3 border-b border-white/20 dark:border-white/5 bg-white/20 dark:bg-black/35 backdrop-blur-md flex-shrink-0">
          <Link
            href="/dashboard"
